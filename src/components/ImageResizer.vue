        ...
        <div class="md-layout-item">
            <md-card class="image-resizer-card">
                <md-card-header>
                    ...
                    <div class="md-subheading">Upload an Image to see how it would look with the <a href="https://yeleha.co/2O08YwS" target="_blank">EU's copyright law 128x128 size restrictions</a> applied</div>
                </md-card-header>
